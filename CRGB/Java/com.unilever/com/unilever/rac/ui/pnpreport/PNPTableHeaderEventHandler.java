...
public class PNPTableHeaderEventHandler implements IEventHandler {
     ...
     public PNPTableHeaderEventHandler(Document doc, TCComponent pamRevision, String timestamp) {
    	 String PAM_id = null;
         String revid  = null;
         String owner  = null;
         String name  = null;
        ...
        // table2.setHeight(110f);
         ...
         try {
	        ...
	        site = pamRevision.getProperty("u4_site");
