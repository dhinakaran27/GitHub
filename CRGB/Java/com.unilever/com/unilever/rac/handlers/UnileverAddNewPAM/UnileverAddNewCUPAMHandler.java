...
public class UnileverAddNewCUPAMHandler extends AbstractHandler {
	...
	public Object execute( ExecutionEvent event ) throws ExecutionException {
		...
		{
			new UnileverAddNewPAMDialog( shell, SWT.APPLICATION_MODAL | SWT.CLOSE, selection, session, UL4Common.PnP_TO_PAM_CU_RELATION).open();			
		}
