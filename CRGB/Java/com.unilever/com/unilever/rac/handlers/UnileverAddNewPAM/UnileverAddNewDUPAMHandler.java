...
public class UnileverAddNewDUPAMHandler extends AbstractHandler {
	...
	public Object execute( ExecutionEvent event ) throws ExecutionException {
		...
		{
			new UnileverAddNewPAMDialog( shell, SWT.APPLICATION_MODAL | SWT.CLOSE, selection, session, UL4Common.PnP_TO_PAM_DU_RELATION).open();			
		}		
